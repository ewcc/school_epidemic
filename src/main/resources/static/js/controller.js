...
function get_r1_data() {
    $.ajax({
        ...
        success: function (response) {
            //  console.log(response);
            ec_right1_option.xAxis[0].data = response.day;
            ec_right1_option.series[0].data = response.confirm;
            ec_right1_option.series[1].data = response.suspect;
            ec_right1_option.series[2].data = response.heal;
            ec_right1_option.series[3].data = response.dead;
...
var interval = setInterval(get_c1_data, 1000);
